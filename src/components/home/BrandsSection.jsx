...
export default function BrandsSection() {
  return (
    <section className="container-rs py-8">
      <SectionHeader title="Our Brands (Sister Concerns)" linkLabel="View All Brands" to="/brands" />
        ...
        {brands.map((brand) => (
          ...
          >
            ...
            <div className="mt-auto flex w-full flex-col gap-1.5">
              <button className="rounded-lg bg-brand-gradient px-2 py-1.5 text-[11px] font-semibold text-white transition hover:opacity-95">
                Visit Website
              </button>
              <button className="rounded-lg border border-white/12 px-2 py-1.5 text-[11px] font-semibold text-cloud-300 transition hover:bg-white/5">
                Explore Products
              </button>
            </div>
          </div>
